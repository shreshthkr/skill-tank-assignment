...
const Navbar = () => {
  ...
  return (
    <NAVBAR>
      ...
      <div className='authentication-container'>
        {!state ? (<>
        <button onClick={onOpen}><CgProfile fontSize={"29px"} color='rgb(115,86,136)' /></button>
        </>
        ) 
        :
         (<Popover>
 ...
 <Modal isOpen={isOpen} onClose={onClose} size={"lg"}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>{!login ? <h1>Login</h1> : <h1>Signup</h1>}</ModalHeader>
          <ModalCloseButton />
          <ModalBody style={{
           width:"100%",
           display:"flex",
            ...
            {!login ? (<div style={{
              ...
              justifyContent:"center"
                 ...
                 <div style={{
                  ...
                  height:"100%",
                  textAlign:"center",
                  backgroundColor: activeLogin === 'login' ? "#735688" : "white",
                 ...
                 <div style={{
                  ...
                  height:"100%",
                  textAlign:"center",
                  backgroundColor: activeLogin === 'signup' ? "#735688" : "white",
